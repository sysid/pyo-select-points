...
class BaseModel(object):
    ...
    def solve(self, tee: bool = False, *args, **kwargs):
        ...
        If you want constraint names to show up in the Gams file you need to add “symbolic_solver_labels=True”

        :param tee: outputs the solve output to console
        :param args:
        :param kwargs: symbolic_solver_labels=True
        :return:
        """
    ...
    def show_result(self, result):
        if (result.solver.status == SolverStatus.ok) and (
            ...
            _log.warning("# no feasible solution found")
        else:
